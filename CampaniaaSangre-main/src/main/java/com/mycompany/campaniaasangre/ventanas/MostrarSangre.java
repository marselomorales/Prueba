 ...
 * @author kndre
 */
public class MostrarSangre extends javax.swing.JFrame {
    private BancoSangre banco;
    private DefaultTableModel tableModel;
    /**
     * Creates new form MostrarDonantes
     */
    public MostrarSangre(BancoSangre banco) {
        this.banco = banco;
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Tipo de sangre", "Cantidad de sangre donada"
            }
        ) {
    ...
    private void llenarTabla(){
       ...
       model.setRowCount(0);
        ...
        // Obtener las reservas de sangre
        Map<String, Integer> reservasSangre = banco.getReservasSangre(); // Asumiendo que tienes un método para obtener esto

        // Llenar el modelo con las reservas
        for (Map.Entry<String, Integer> entry : reservasSangre.entrySet()) {
            model.addRow(new Object[]{entry.getKey(), entry.getValue()}); // Agregar una fila
        }
    }
